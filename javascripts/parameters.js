...
function getNewParameter(idx){
	var new_parameter = '<tr>'+
          '<td>'+
          '<input class="module_input" name="m_parameter_name'+idx+'" type="text" id="m_parameter_name'+idx+'" value="New Parameter '+idx+'" size="25"></td>'+
          '<td>'+
            '<select class="module_input" name="m_type'+idx+'" id="m_type'+idx+'">'+
          ...
          '</select></td>'+
          '<td><select name="state'+idx+'" id="state'+idx+'" class="module_input">'+
            '<option value="Enabled" selected>Enabled</option>'+
            '<option value="Disabled">Disabled</option>'+
            '<option value="Exported">Exported</option>'+
          '</select></td>'+
          '<td><input class="module_input" type="checkbox" name="m_required'+idx+'" id="m_required'+idx+'"></td>'+
         ' <td><input class="module_input" name="m_input'+idx+'" type="checkbox" id="m_input'+idx+'" checked></td>'+
        '</tr> ';
